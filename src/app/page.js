    ...
    <main className="relative w-full h-full">
      ...
      {isModalFormOpen && (
        <div className="absolute w-full h-full bg-[rgba(0, 0, 0, 0.6)]">
          <div className="absolute mt-[calc(50%-640px)] ml-[calc(50%-210px)] mx-auto py-[40px] px-[30px] w-[420px] h-[480px] bg-[rgba(255,255,255,0.04)] backdrop-blur-sm border-[2px] border-[#bf5af2] rounded-[20px] z-[30]">
            <button
